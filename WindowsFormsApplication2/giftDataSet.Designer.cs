...
namespace WindowsFormsApplication2 {
    ...
    public partial class giftDataSet : global::System.Data.DataSet {
        ...
        public partial class UserDataTable : global::System.Data.TypedTableBase<UserRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow AddUserRow(string name, System.DateTime dob, string gender, string address, string emailid, string contactno, string password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UserRow FindByemailid(string emailid) {
        ...
        public partial class UserRow : global::System.Data.DataRow {
            ...
            public string contactno {
                get {
                    return ((string)(this[this.tableUser.contactnoColumn]));
                }
                set {
...
namespace WindowsFormsApplication2.giftDataSetTableAdapters {
    ...
    public partial class UserTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[User] WHERE (([name] = @Original_name) AND ([dob] = @Original_" +
                "dob) AND ([gender] = @Original_gender) AND ([emailid] = @Original_emailid) AND (" +
                "[contactno] = @Original_contactno) AND ([password] = @Original_password))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[User] ([name], [dob], [gender], [address], [emailid], [contactno], [password]) VALUES (@name, @dob, @gender, @address, @emailid, @contactno, @password);
SELECT name, dob, gender, address, emailid, contactno, password FROM [User] WHERE (emailid = @emailid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[User] SET [name] = @name, [dob] = @dob, [gender] = @gender, [address] = @address, [emailid] = @emailid, [contactno] = @contactno, [password] = @password WHERE (([name] = @Original_name) AND ([dob] = @Original_dob) AND ([gender] = @Original_gender) AND ([emailid] = @Original_emailid) AND ([contactno] = @Original_contactno) AND ([password] = @Original_password));
SELECT name, dob, gender, address, emailid, contactno, password FROM [User] WHERE (emailid = @emailid)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApplication2.Properties.Settings.Default.giftConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT name, dob, gender, address, emailid, contactno, password FROM dbo.[User]";
        ...
        public virtual int Fill(giftDataSet.UserDataTable dataTable) {
        ...
        public virtual giftDataSet.UserDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            giftDataSet.UserDataTable dataTable = new giftDataSet.UserDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(giftDataSet.UserDataTable dataTable) {
        ...
        public virtual int Delete(string Original_name, System.DateTime Original_dob, string Original_gender, string Original_emailid, string Original_contactno, string Original_password) {
        ...
        public virtual int Insert(string name, System.DateTime dob, string gender, string address, string emailid, string contactno, string password) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, System.DateTime dob, string gender, string address, string emailid, string contactno, string password, string Original_name, System.DateTime Original_dob, string Original_gender, string Original_emailid, string Original_contactno, string Original_password) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, System.DateTime dob, string gender, string address, string contactno, string password, string Original_name, System.DateTime Original_dob, string Original_gender, string Original_emailid, string Original_contactno, string Original_password) {
            return this.Update(name, dob, gender, address, Original_emailid, contactno, password, Original_name, Original_dob, Original_gender, Original_emailid, Original_contactno, Original_password);
        }
    }
